<?php
    $limit = 4; 
    $query_new = "SELECT products.*, categories.name AS category_name FROM products JOIN categories ON products.category_id = categories.id WHERE products.status = 2 ORDER BY products.id DESC LIMIT $limit";
