...
<body class="font-default">
    <header>
        <div class="top-header mx-5">
            ...
            <article class="px-4 text-hover">
            <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" class="bi bi-threads-fill" viewBox="0 0 16 16">
        ...
        <div class="body-wrapper">
           ...
           <div class="product-card d-flex flex-column">
                   <div class="product-card-image position-relative">
                    <article class="top-button position-absolute py-4">
                        <button class="btn-new text-white">New</button>
                    </article>
                    <img src="<?=ROOT?>/assets/vectors/netflix-product.png" class="img-fluid" alt="product image"/>
                   </div>
                   <div class="product-card-content my-2 mx-4">
                    <h4>Streaming</h4>
                    <h5>Netflix</h5>
                    <article class="my-2">
                    ...
                    <div class="product-buttons d-flex mt-4 mb-2 justify-content-between">
                        <button class="price-box text-green font-oswold">
                            <span>KSH</span>
                            <span>500</span>
                        </button>
