...
<body class="font-default">
    <header>
        <div class="top-header d-flex justify-content-between my-3 mx-5">
        ...
        <nav>
            <div class="d-flex justify-content-between my-4 mx-4">
                <div class="hamburger d-none">
                    ...
                    <h1 class="logo"><span class="text-black">Accs</span><span class="text-green">Zone.</span></h1>
                <div>
        ...
        <div class="low-header d-flex align-items-center mx-5">
